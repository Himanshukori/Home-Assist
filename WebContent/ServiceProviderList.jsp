...
<% 
			...
			ResultSet rs=st.executeQuery("select * from serviceprovider_regs");
			%>
			<h1 align=center color=blue>Service Provider list</h1>
			<table>
			...
			%>	
					...
					******
					...
					<td>
					<a href=DeleteServiceProvider?suname=<%= username %>>Delete</a>
					</td>
					<!-- 
					<td>
