...
<% 
			...
			ResultSet rs=st.executeQuery("select * from shop where Shop_Service='"+service+"' AND Shop_Area='"+area+"'");
			%>
			<% 
			...
			<table>
			<th>Shop Name</th><th>Shop Opening Time</th><th>Shop Closing Time</th><th>Shop Contact</th><th>Book</th>
			<%
			if(rs.next())
			{
				do
			...
			else
			{
				...
				out.println("No Shop available at this region!!!Try other area ...");
